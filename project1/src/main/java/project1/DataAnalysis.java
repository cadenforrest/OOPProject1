...
public class DataAnalysis {
  ...
  /**
   * Sorts list by degree
   * @param inList List of AbstractRatingSummaries
   * @return sorted list
   */
  ...
  /**
   * Sorts list by differences in product average and reviewer average
   * @param inList List of AbstractRatingSummaries
   * @return sorted list
   */
  ...
  /**
   * Generates a report containing k items from data in inList
   * @param inList List of AbstractRatingSummary objects
   * @param k integer value for number of items to print 
  ...
  /**
   * appends top k lines to a string
   * @param inList List of AbstractRatingSummary objects
   * @param k integer value for number of items to print 
   * @return string containing 0th-kth AbstractRatingSummary objects from inList
   */
